                ...
                <div class="m-accordion__item">
                    ...
                    <div class="m-accordion__item-body collapse" id="m_accordion_1_item_1_body" role="tabpanel" aria-labelledby="m_accordion_1_item_1_head" data-parent="#m_accordion_1">
                        <div class="m-accordion__item-content">
                            <form action="{{route('user.domainList.renewWithPaypal')}}" method="POST" id="paypal_submit_form">
                                @csrf
                                @honeypot
...
<script>
    var stripe_pk = "{{$stripe_pk}}", total="{{$price->sumPrice*100}}";
    ...
    <script>
        ...
        function registerElements(elements, exampleName) {
            ...
            function stripeFormSubmit() {
                ...
                $.ajax({
                    url:"/account/domainList/renewWithStripe",
                    method:"POST",
                    data:formData,
                    dataType:'JSON',
                    contentType:false,
