...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-light ">
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light position-static" m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500">
        <ul class="m-menu__nav ">
            <li class="m-menu__item {{ Request::is('client/dashboard*') ? 'm-menu__item--active ' : '' }}" aria-haspopup="true">
                <a href="{{route('client.dashboard')}}" class="m-menu__link ">
            ...
            <li class="m-menu__item {{ Request::is('client/chat*')? 'm-menu__item--active' : '' }}" aria-haspopup="true">
                <a href="{{route('client.chat.index')}}" class="m-menu__link" >
                    <span class="m-menu__item-here"></span>
