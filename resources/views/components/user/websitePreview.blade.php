                    ...
                    <div class="menu_area alt-font">
                        <nav class="navbar navbar-expand-lg navbar-light no-padding justify-content-between">
                            ...
                            <div class="navbar-header navbar-header-custom p-2">
                                <div class="handle_switch_area flex">
                                    <a href="javascrpit:void(0);" data-hook="desktop_view" class="view_switch_btn active pl-11">
                                    ...
                                    <a href="javascrpit:void(0);" data-hook="pad_view" class="view_switch_btn pl-11">
                                    ...
                                    <a href="javascrpit:void(0);" data-hook="mobile_view" class="view_switch_btn pl-11">
                                ...
                                <ul>
                                    ...
                                    <li class="list-style-none float-left m-1">
                                        <a href="#" class="btn btn-outline-success choose_btn"
                                           ...
                                           data-name="{{$template->name}}">Choose Template</a>
                                    </li>
                                </ul>
                            </div>
