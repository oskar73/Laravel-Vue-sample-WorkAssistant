...
@if($category!==null)
    <a href="{{$category->getFirstMediaUrl('image')}}" class="w-100 progressive replace" style="height:300px !important">
    ...
    @forelse($items as $item)
        <div class="col-lg-4 mb-5  m-auto">
            <div class="project-grid-style3">
                <a href="{{route('plugin.detail', $item->slug)}}" class="inner-box">
                    <div class="position-relative">
                        ...
                        <figure data-href="{{$item->getFirstMediaUrl('thumbnail')}}" class="w-100 progressive replace" style="height:300px !important">
