            ...
            <div class="row flex-row flex-nowrap">
                @foreach($boxes1 as $box)
                    <div class="col-md-2 col-sm-3 col-6 my-2">
                        @include('components.front.portfolio-box-item')
                    </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="col-12 overflow-x-auto cat_scroll_container my-3">
            <div class="row flex-row flex-nowrap align-items-center boxes-2">
                @foreach($boxes2 as $i => $box)
                                    ...
                                    <div class="col-12 position-relative">
                                        <div class="preview-wrapper" @if($i === 2) style="--aspect-ratio: 1.5" @endif>
                                            <div class="thumbnail_overlay">
                                                <div  class="img_area">
                                                    <figure data-href="{{uploadUrl(option('portfolio.front.box.image'),'center-box.png')}}" class="w-100 progressive replace m-0" >
                                                        <img src="{{uploadUrl(option('portfolio.front.box.image.thumb'),'center-thumb.png')}}" alt="bizinabox home page portfolio" class="preview img-full" />
                                                    </figure>
                                                </div>
                    ...
                    @else
                        <div class="col-md-2 col-sm-3 col-6 home-box-{{$i}}">
                            @include('components.front.portfolio-box-item')
                        </div>
                    @endif
                @endforeach
