        ...
        <tbody>
            @forelse($pages as $page)
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.template.item.preview', ['slug'=>$template->slug, 'url'=>$page->url])}}"
                        ...
                        <a href="{{route('admin.template.page.editContent', ['id'=>$page->id,'type'=>'builder'])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit Page">
