        ...
        <tbody>
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td>
                        <a href="{{ $category->getFirstMediaUrl('image') }}"
                            class="width-300px progressive replace m-auto">
                            <img src="{{ $category->getFirstMediaUrl('image', 'thumb') }}" alt="{{ $category->name }}"
                                class="width-300px preview">
                        </a>
                    </td>
                    <td>
