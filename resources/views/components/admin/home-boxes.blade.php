<div class="table-responsive">
    <table class="table table-hover ajaxTable datatable">
        ...
        @foreach($boxes as $box)
            <tr>
                <td><input type="checkbox" class="checkbox" data-id="{{$box->id}}"></td>
                <td>
                    <a href="{{$box->getFirstMediaUrl('image')}}" class="w-100 progressive replace">
                        <img src="{{$box->getFirstMediaUrl('image')}}" class="width-150 preview">
                    </a>
                </td>
                <td>
                    {{$box->name}}
                ...
                <td>
                    <a href="javascript:void(0);"
                       ...
                       data-item="{{$box}}"
                       data-image="{{$box->getFirstMediaUrl('image')}}"
                    >
                        <span>
