    ...
    <table class="table table-hover ajaxTable datatable {{$selector}}">
        ...
        @foreach($items as $item)
            <tr>
                ...
                <td>
                    {{$item->campaign_number==-1? 'Unlimit': $item->campaign_number}}
                </td>
                <td>
                ...
                <td>
                    <a href="{{route('admin.email.package.edit', $item->id)}}" class="btn btn-outline-info btn-sm m-1	p-2 m-btn m-btn--icon edit_btn">
                        <span>
