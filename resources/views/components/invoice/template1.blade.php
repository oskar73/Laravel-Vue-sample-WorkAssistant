        ...
        <tr class="top">
            <td colspan="3">
                <table>
                    <tr>
                        <td class="title">
                            <img src="{{asset('assets/img/logo.png')}}" style="width:100%; max-width:300px;min-width:200px;">
                        </td>
...
{{--                            Due: February 1, 2015--}}
        ...
        @if($invoice->transaction->recurrent==1)
            <tr class="item last">
                <td>
                    {{json_decode($invoice->transaction->orderItem->product_detail)->name}} ({{$invoice->transaction->orderItem->product_type}})
                </td>
                <td>
