<form action="{{ route('user.template.item.updateTemplate', $template->id) }}" id="submit_form" method="post"
        ...
        <div class="col-md-6">
            <div class="form-group m-form__group">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input uploadImageBox" id="image" name="image"
                        data-target="preview">
...
<script src="{{ asset('assets/js/user/template/editItem.js') }}"></script>
