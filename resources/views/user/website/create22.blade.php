                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <br>
                                <a href="{{route('user.website.index')}}" class="btn btn-outline-info m-btn m-btn--custom m-btn--square m-1">Back</a>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="template" id="template" data-live-search="true" data-width="100%">
