        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Transfer</span>
                </a>
            </li>
        </ul>
    </div>
            ...
            <form class="domain-search" id="search-form">
                ...
                <div class="container">
                    <div class="text-center mb-3">
                        <a href="{{route('user.domain.search')}}" class="btn m-btn--square  btn-outline-info m-btn m-btn--custom">Register</a>
                        <a href="javascript:void();" class="btn m-btn--square btn-info m-btn m-btn--custom">Transfer</a>
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" name="domain" id="domain" class="form-control domain_search_box" autocomplete="off">
                        <button type="submit" class="btn btn-info smtBtn"><i class="fa fa-search fa-2x"></i></button>
                    </div>
...
<script src="{{asset('assets/js/user/domain/transfer.js')}}"></script>
@endsection
