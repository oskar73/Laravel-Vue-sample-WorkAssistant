    ...
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('user.purchase.order.index') }}" class="m-nav__link">
                    ...
                    <tbody id="video_area">
                        @foreach($order->items as $item)
                            <tr>
                                ...
                                <td>
                                    @if($item->status!=='active')
                                        <button class="btn btn-outline-info btn-sm m-1 p-2 m-btn m-btn--icon confirm_btn" data-id="{{ $item->id }}">
                                            <span>
                                    ...
                                    @endif
                                    {{-- <button class="btn btn-outline-danger btn-sm m-1 p-2 m-btn m-btn--icon del_btn" data-id="{{ $item->id }}">
                                        <span>
