...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('user.purchase.service.index')}}" class="btn m-btn--square  btn-outline-info m-btn m-btn--custom">
            Back
        </a>
    </div>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @if($item->package_pid!=0)
                           <p class="fs-14 mb-0">
                               <b>Payment</b>: by
                               <a href="{{$item->pPackage->package==1?route('user.purchase.package.detail', $item->pPackage->id):route('user.purchase.readymade.detail', $item->pPackage->id)}}">{{$item->pPackage->getName()}}</a>
                           </p>
                        @endif
                    </div>
