...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="javascript:void(0)" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success mb-2 newUnit">New Unit</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active"  data-area="#all" href="#/all"> Units </a></li>
        </ul>
    </div>
    ...
    @include("components.user.addUnitModal")
@endsection
@section('script')
    <script src="{{asset('assets\js\user\product\unit.js')}}"></script>
@endsection
