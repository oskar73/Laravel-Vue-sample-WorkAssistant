        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Sub-Categories</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="col-md-6 text-right">
        <a href="javascript:void(0)" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success mb-2 newSubCategory">New Sub-Category</a>
    </div>
@endsection
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active"  data-area="#all" href="#/all"> Sub-Categories </a></li>
        </ul>
    </div>
    ...
    @include("components.user.addSubCategoryModal")
@endsection
@section('script')
    <script src="{{asset('assets\js\user\product\sub-category.js')}}"></script>
@endsection
