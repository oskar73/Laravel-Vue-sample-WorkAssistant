...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        ...
        <a href="{{route('user.appointment.category.create')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success mb-2">Create</a>
    </div>
@endsection
...
@section('script')
    ...
    <script src="{{asset('assets/js/user/appointment/own/category.js')}}"></script>
@endsection
