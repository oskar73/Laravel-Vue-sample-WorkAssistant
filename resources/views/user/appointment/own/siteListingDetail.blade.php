                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="text-right">
                                    ...
                                    <a href='//{{$list->site->domain}}' target='_blank'>{{$list->site->domain}}<i class='la la-external-link'></i></a>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script src="{{asset('assets/js/user/appointment/own/siteListingDetail.js')}}"></script>
@endsection
