...
@section('script')
    <script>
        window.getUrl = '{{ route('user.palettes.data', ['type' => 'simple']) }}'
        window.storeUrl = '{{ route('user.palettes.store', ['type' => 'simple']) }}'
        window.removeUrl = '{{ route('user.palettes.delete', ['type' => 'simple']) }}'
        window.updateUrl = '{{ route('user.palettes.update', ['type' => 'simple']) }}'
        window.sortUrl = '{{ route('user.palettes.sort', ['type' => 'simple']) }}'
    </script>
