...
@section('script')
    ...
    <script>
      let getDataTableUrl = '{{route('user.palettes.categories.datatable', ['type' => 'advanced'])}}'
      let sortViewUrl = '{{route('user.palettes.categories.sort.view', ['type' => 'advanced'])}}'
      let sortUrl = '{{route('user.palettes.categories.sort', ['type' => 'advanced'])}}'
      let storeUrl = '{{route('user.palettes.category.store', ['type' => 'advanced'])}}'
      let switchUrl = '{{route('user.palettes.category.switch', ['type' => 'advanced'])}}'
    </script>
