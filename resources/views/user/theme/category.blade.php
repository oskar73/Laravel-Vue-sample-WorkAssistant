    ...
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('user.theme.category.index') }}" class="m-nav__link">
...
@section('script')
    <script>
        let maxImageSize = "{{config('custom.variable.max_image_size')}}";
        let getThemeCategoryUrl = '{{ route('user.theme.category.index') }}'
        let createThemeCategoryUrl = '{{ route('user.theme.category.store') }}'
        let getThemeCategorySortUrl = '{{ route('user.theme.category.get-sort') }}'
        let updateThemeCategorySortUrl = '{{ route('user.theme.category.update-sort') }}'
        let switchThemeCategoryUrl = '{{ route('user.theme.category.switch') }}'
    </script>
    <script src="{{s3_asset('vendors/jquery/jquery-ui.min.js')}}"></script>
    <script src="{{asset('assets/js/user/theme/category.js')}}"></script>
@endsection
