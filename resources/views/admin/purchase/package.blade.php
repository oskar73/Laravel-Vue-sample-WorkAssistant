...
@section('breadcrumb')
    ...
    <div class="col-md-6">
        @include("components.admin.productRadio", ["item"=>$item])
    </div>
@endsection
...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="all_area">
        <div class="m-portlet__body">
            @include('components.admin.pPackageTable', ['selector'=>'datatable-all', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="active_area">
        <div class="m-portlet__body">
            @include('components.admin.pPackageTable', ['selector'=>'datatable-active', 'user'=>1])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="inactive_area">
        <div class="m-portlet__body">
            @include('components.admin.pPackageTable', ['selector'=>'datatable-inactive', 'user'=>1])
        </div>
    </div>

@endsection
@section('script')
    <script>var item="{{$item}}";</script>
    <script src="{{asset('assets/js/admin/purchase/package.js')}}"></script>
@endsection
