...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.purchase.'.$type.'.index')}}" class="btn m-btn--square  btn-outline-info m-btn m-btn--custom">
            Back
        </a>
    </div>
@endsection
        ...
        <div class="m-portlet__body">
            <div class="container">
                ...
                <div class="fs-14">
                    ...
                    <b>Details</b>: <br>
                    <div class="pl-3">
                        <b>Free Domain</b>:1 <br>
                        <b>Websites</b>:{{$detail->website}} <br>
                        <b>Pages per website</b>:{{$detail->page}} <br>
                        <b>Modules per website</b>:{{$detail->module}} <br>
                        <b>Featured Modules per website</b>:{{$detail->featured_module}} <br>
                    </div>
                </div>
                <hr>
                <div class="fs-14">
                    ...
                    <table class="table table-bordered table-item-center datatable">
                        ...
                        <tbody>
                            @foreach($item->websites as $website)
                                <tr>
                                    <td><a href="{{route('admin.website.list.edit', $website->id)}}">{{$website->name}} <i class="fa fa-eye"></i></a></td>
                                    ...
                                    <td>
                                        <a href="{{route('admin.website.list.edit', $website->id)}}" class="btn m-btn--square btn-outline-info m-btn m-btn--custom p-2">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="table table-bordered table-item-center datatable">
                        ...
                        @foreach($item->domains as $domain)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.domainList.show', $domain->id)}}" class="btn m-btn--square btn-outline-info m-btn m-btn--custom p-2">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                    ...
                    <table class="table table-bordered table-item-center datatable">
                        ...
                        @foreach($item->plugins as $plugin)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.purchase.plugin.detail', $plugin->id)}}" class="btn m-btn--square btn-outline-info m-btn m-btn--custom p-2">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        @foreach($item->services as $service)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.purchase.service.detail', $service->id)}}" class="btn m-btn--square btn-outline-info m-btn m-btn--custom p-2">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        @foreach($item->lacartes as $lacarte)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.purchase.lacarte.detail', $lacarte->id)}}" class="btn m-btn--square btn-outline-info m-btn m-btn--custom p-2">Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
