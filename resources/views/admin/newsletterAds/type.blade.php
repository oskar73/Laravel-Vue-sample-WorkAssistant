...
@section('title', 'Newsletter Advertisement Type')
@section('style')
@endsection
@section('breadcrumb')
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Types (<span
                            class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Types (<span
                            class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Types (<span
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control m-input--square change_pam" name="width"
                                           id="width" autocomplete="off">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control m-input--square change_pam" name="height"
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/newsletterAds/type.js')}}"></script>
@endsection
