...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Emails (<span class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Emails (<span class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Emails (<span class="inactive_count">0</span>)</a></li>
        </ul>
    </div>
                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control m-input--square minh-100" name="content" id="content"></textarea>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/purchasefollowup/email.js')}}"></script>
@endsection
