...
@section('breadcrumb')
    <div class="col-md-6">
        <x-layout.breadcrumb :menus="['Website', 'Edit']" :menuLinks="[]" />
    </div>
    <div class="col-md-6 text-right">
        <x-form.a link="{{route('admin.website.list.index')}}" label="Back" type="info"/>
    </div>
@endsection
...
@section('content')
    ...
    <x-layout.portletBody id="basic_area" active="1">
        <form action="{{route('admin.website.updateBasic', $website->id)}}" id="basic_form">
            @csrf
            <div class="row">
    ...
    <x-layout.portletBody id="owner_area" active="0">
        <form action="{{route('admin.website.updateOwner', $website->id)}}" id="owner_form">
            @csrf
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="form-group">
    ...
    <x-layout.portletBody id="module_area" active="0">
        <form action="{{route('admin.website.updateModule', $website->id)}}" id="module_form">
            @csrf
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
