    ...
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{route('admin.website.list.index')}}" class="m-nav__link">
...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-10 col-md-8">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach($package->services as $service)
                                            <span class="c-badge c-badge-success">{{$service->name}}</span>
                                        @endforeach <br>
                                        @foreach($package->plugins as $plugin)
                                            <span class="c-badge c-badge-info">{{$plugin->name}}</span>
                                        @endforeach <br>
                                        @foreach($package->lacartes as $lacarte)
                                            <span class="c-badge c-badge-light">{{$lacarte->name}}</span>
                                        @endforeach <br>
                                        @foreach($package->modules as $module)
                                            @php array_push($modules, '"'.$module->slug.'"') @endphp
                                            <span class="c-badge c-badge-warning">{{$module->name}}</span>
                                        @endforeach
                                    </td>
                                    <td>
                                        @if($package->status===1)
                                    ...
                                    <td>
                                        <a class="btn btn-outline-success m-btn--sm tab-link package_start_btn"
                                            ...
                                            data-modules="{{empty($modules) ? '[]':"[".implode(',', $modules)."]"}}"
                                        >Start</a>
                                    </td>
                                </tr>
                            @empty
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-2 mt-3">
                            ...
                            <div class="form-group m-option--sm navbar-choose-container custom-scroll-h">
                                <label class="m-option h-cursor">
                                    <span class="m-option__control">
                                        <span class="m-radio m-radio--brand m-radio--check-bold">
                                            <input type="radio" name="navbar" value="0" >
                                            <span></span>
                                        </span>
                                    </span>
                                    <span class="m-option__label">
                                ...
                                <label class="m-option h-cursor">
                                    <span class="m-option__control">
                                        <span class="m-radio m-radio--brand m-radio--check-bold">
                                            <input type="radio" name="navbar" value="{{$header->id}}" >
                                            <span></span>
                                        </span>
                                    </span>
                                    <span class="m-option__label">
                            ...
                            <label for="footer">Footer Style</label>
                            <div class="form-group m-option--sm navbar-choose-container custom-scroll-h">
                                <label class="m-option h-cursor">
                                    <span class="m-option__control">
                                        <span class="m-radio m-radio--brand m-radio--check-bold">
                                ...
                                @foreach($footers as $footer)
                                    <label class="m-option h-cursor">
                                        <span class="m-option__control">
                                            <span class="m-radio m-radio--brand m-radio--check-bold">
                                                <input type="radio" name="footer" value="{{$footer->id}}" >
                                                <span></span>
                                            </span>
                                        </span>
                                            <span class="m-option__label">
            ...
            <x-layout.portlet active="0" id="review_area" label="Review Detail">
                <x-form.form action="{{route('admin.website.getting.submit')}}">
                    <div class="container">
                        <div class="row">
    ...
    <div class="template_preview_window">
...
@section('script')
    <script>
        ...
        var userTypeUrl = '/admin' //Need to set as we are sharing same started.js for both admin and user
    </script>
