            ...
            <div class="modal-content">
                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger m-btn m-btn--square" data-dismiss="modal">Cancel</button>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/service/category.js')}}"></script>
@endsection
