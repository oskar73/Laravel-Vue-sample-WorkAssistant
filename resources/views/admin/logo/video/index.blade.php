...
@section('breadcrumb')
    <div class="col-md-6 text-left">
        <x-layout.breadcrumb :menus="['videos']"/>
    </div>
    <div class="col-md-6 text-right">
        <x-form.a link="{{route('admin.video.item.create')}}" label="Create" type="success"/>
    </div>
@endsection
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/logo/video/index.js')}}"></script>
@endsection
