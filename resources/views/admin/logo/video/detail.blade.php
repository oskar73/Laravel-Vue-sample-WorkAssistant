...
@section('breadcrumb')
    <div class="col-md-6 text-left">
        <x-layout.breadcrumb :menus="['videos', 'Detail']"/>
    </div>
    <div class="col-md-6 text-right">
        <x-form.a link="{{route('admin.video.item.index')}}" type="info" label="Back"/>
        <x-form.a link="{{route('admin.video.item.edit', $item->id)}}" type="success" label="Edit" />
    </div>
@endsection

@section('content')
    <x-layout.portlet id="all_area" active="1" label="video Detail">
        <x-layout.container>
