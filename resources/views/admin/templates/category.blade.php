    ...
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="{{ route('user.template.item.index') }}" class="m-nav__link">
...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            ...
            <li class="tab-item"><a class="tab-link" data-area="#subcategory" href="#/subcategory"> Subcategories (<span
                        class="subcategory_count">0</span>)</a></li>
        </ul>
    </div>
                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="category" class="form-control-label">Choose Parent Category:
                                <i class="la la-info-circle tooltip_icon" title='{{ $tooltip[1] }}'
                                    data-page="{{ $view_name }}" data-id="1"></i>
                            </label>
                            <select name="parent_id" id="parent" class="selectpicker" data-live-search="true"
                                data-width="100%">
                        ...
                        <div class="form-group">
                            <label for="name" class="form-control-label">Name:
                                <i class="la la-info-circle tooltip_icon" title='{{ $tooltip[2] }}'
                                    data-page="{{ $view_name }}" data-id="2"></i>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="description" class="form-control-label">Description:
                                <i class="la la-info-circle tooltip_icon" title='{{ $tooltip[3] }}'
                                    data-page="{{ $view_name }}" data-id="3"></i>
                            </label>
...
@section('script')
    <script>
        var maxImageSize = "{{ config('custom.variable.max_image_size') }}";
    </script>
    ...
    @if (isset($user) && $user)
        <script src="{{ asset('assets/js/user/template/category.js') }}"></script>
    @else
        <script src="{{ asset('assets/js/admin/template/category.js') }}"></script>
    @endif
@endsection
