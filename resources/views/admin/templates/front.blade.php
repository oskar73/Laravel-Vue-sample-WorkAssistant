...
@section('title', 'Templates Front Setting')
...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <form method="post" action="{{route('admin.template.front.store')}}" id="submit_form" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group m-form__group" x-show="status">
                                ...
                                <div class="slimdiv">
                                    <input type="file" data-url="{{ option('templates.front.header.image') }}" name="headerImage" id="slimInput1"/>
                                </div>
                            </div>
                            <div class="form-group m-form__group" >
                                ...
                                <div class="slimdiv">
                                    <input type="file"  data-url="{{ option('templates.front.box.image') }}"  name="boxImage" id="slimInput2"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <h4 class="my-4 text-bold">Template SEO Setting</h4>
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <img src="{{uploadUrl($seo['image']??'')}}" id="preview" class="w-100 mt-3 img bordered" alt="meta image">
                            </div>
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{asset('assets/js/admin/template/front.js')}}"></script>
@endsection
