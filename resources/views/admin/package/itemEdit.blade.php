...
@section('breadcrumb')
    <div class="col-md-6">
        <x-layout.breadcrumb :menus="['Package', 'Edit Item']" :menuLinks="[]" />
    </div>
...
@section('content')
    ...
    <x-layout.portletBody id="all_area" active="1">
        <x-form.form action="{{route('admin.package.item.update', $item->id)}}">
            <div class="row">
                <div class="col-md-6">
                        ...
                        @foreach($item->getMedia('image') as $key=>$image)
                            <tr>
                                ...
                                <td class="text-center">
                                    <figure data-href="{{$image->getUrl()}}" class="width-150 replace m-auto">
                                        <img class='width-80px height-80px object-fit'
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-5" style="height: 300px; width: 300px; margin: auto">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <x-form.status name="featured" label="Featured?"
                                           checked="{{$item->featured==1? 'checked':''}}" />
                        </div>
                        <div class="col-4">
                            <x-form.status name="new" label="New?" checked="{{$item->new==1? 'checked':''}}" />
                        </div>
                        <div class="col-4">
                            <x-form.status name="status" label="Approve?"
    ...
    <x-layout.portletBody id="item_area" active="0">
        <x-layout.container>
            <h2>Set Items</h2>
            <form id="setItemForm" action="{{route('admin.package.item.updateModule', $item->id)}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="module" class="form-control-label">Choose Recommend Modules:</label>
                                    <br>
                                    <select name="modules[]" class="select2_item m-select2" multiple>
                                        @foreach($modules as $module)
                                            ...
                                            >
                                                {{$module->name}} {{$module->featured? '(Featured)':''}}
                                                , {{$module->standardPrice->getPriceText()}}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            <label for="free_domain_price" class="form-control-label">Domain Discount Price ($):</label>
                            <br>
                            <input type="text" class="form-control m-input--square" name="free_domain_price"
                                   value="{{$item->domain}}">
                            <div class="form-control-feedback error-free_domain_price"></div>
                        </div>
                    </div>
                    <div class="col-md-6"
                         x-data="{module:'{{$item->module==-1? 1:0}}',featured_module:'{{$item->featured_module==-1? 1:0}}',page:'{{$item->page==-1? 1:0}}',storage:'{{$item->storage==-1? 1:0}}',website:'{{$item->website==-1? 1:0}}'}">
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="module_count" class="form-control-label">Number of available
                                        modules</label>
                                    <input type="text" class="form-control m-input--square" name="module_count"
                                           x-bind:disabled="module==1" value="{{$item->module==-1? '':$item->module}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="m-checkbox-list pt-2">
                                        <label class="m-checkbox m-checkbox--state-success">
                                            <input type="checkbox" name="module_unlimit" id="module_unlimit"
                                                   x-on:click="module=module==1?0:1" x-bind:checked="module==1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control m-input--square" name="page_count"
                                           x-bind:disabled="page==1" value="{{$item->page==-1? '':$item->page}}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="m-checkbox-list pt-2">
                                        <label class="m-checkbox m-checkbox--state-success">
                                            <input type="checkbox" name="page_unlimit" id="page_unlimit"
                                                   x-on:click="page=page==1?0:1" x-bind:checked="page==1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control m-input--square" name="storage"
                                           x-bind:disabled="storage==1"
                                           value="{{$item->storage==-1? '':$item->storage}}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="m-checkbox-list pt-2">
                                        <label class="m-checkbox m-checkbox--state-success">
                                            <input type="checkbox" name="storage_unlimit" id="storage_unlimit"
                                                   x-on:click="storage=storage==1?0:1" x-bind:checked="storage==1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="website_count" class="form-control-label">Number of available
                                        websites</label>
                                    <input type="text" class="form-control m-input--square" name="website_count"
                                           x-bind:disabled="website==1"
                                           value="{{$item->website==-1? '':$item->website}}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="m-checkbox-list pt-2">
                                        <label class="m-checkbox m-checkbox--state-success">
                                            <input type="checkbox" name="website_unlimit" id="website_unlimit"
                                                   x-on:click="website=website==1?0:1" x-bind:checked="website==1">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="text-right">
                    <button type="submit"
                            class="btn m-btn--square m-btn m-btn--custom btn-outline-success setItemSmtBtn">Save
                    </button>
                </div>
            </form>
        </x-layout.container>
    ...
    @include("components.admin.common.meetingForm", ['action'=>route('admin.package.item.updateMeetingForm', $item->id)])

    @include("components.admin.common.addPriceModal", ['action'=>route('admin.package.item.createPrice', $item->id)])
...
@section('script')
    ...
    <script>
      var item_id = "{{$item->id}}",
        getPriceUrl = "{{route('admin.package.item.edit', $item->id)}}",
        delPriceUrl = "{{route('admin.package.item.deletePrice', $item->id)}}",
    ...
    <script src="{{asset('assets/js/admin/package/itemEdit.js')}}"></script>
