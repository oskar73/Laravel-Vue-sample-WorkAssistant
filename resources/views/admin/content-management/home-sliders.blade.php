                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="tw-grid tw-grid-cols-2 tw-gap-2 ">
                            <div class="form-group">
                                <label for="button" class="form-control-label">Button Title:</label>
                                <input type="text" class="form-control m-input--square" name="button" id="button">
                            </div>
                            <div class="form-group">
                                <label for="link" class="form-control-label">Button Link:</label>
                                <input type="text" class="form-control m-input--square" name="link" id="link">
                            </div>
                        </div>
                        <div class="form-group">
