...
@section('content')
    ...
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50 area-active" id="all_area">
        <div class="m-portlet__body">
            @include("components.admin.emailTemplateTable", ['selector'=>'datatable-all'])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="active_area">
        <div class="m-portlet__body">
            @include("components.admin.emailTemplateTable", ['selector'=>'datatable-active'])
        </div>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area md-pt-50" id="inactive_area">
        <div class="m-portlet__body">
            @include("components.admin.emailTemplateTable", ['selector'=>'datatable-inactive'])
        </div>
    </div>
@endsection
@section('script')
