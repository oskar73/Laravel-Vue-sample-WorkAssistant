    ...
    <div class="domain_search_area">
        <div class="m-portlet m-portlet--mobile tab_area area-active" id="search_area">
            ...
            <div class="m-portlet__body">
                <form action="{{route('admin.domain.connect')}}" method="POST" class="domain-search" id="search-form">
                    @csrf
                    @honeypot
...
{{--                                    (or <b>CNAME</b>)--}}
                                ...
                                <li>
                                    Point the A record to the following IP address <b>{{optional(option('ssh'))['ip']}}</b>
