                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control m-input--square" name="name"
                                        id="name">
...
@section('script')
    <script>
        let getDataTableUrl = '{{ route('admin.palettes.categories.datatable', ['type' => 'simple']) }}'
        let sortViewUrl = '{{ route('admin.palettes.categories.sort.view', ['type' => 'simple']) }}'
        let sortUrl = '{{ route('admin.palettes.categories.sort', ['type' => 'simple']) }}'
        let storeUrl = '{{ route('admin.palettes.category.store', ['type' => 'simple']) }}'
        let switchUrl = '{{ route('admin.palettes.category.switch', ['type' => 'simple']) }}'
    </script>
