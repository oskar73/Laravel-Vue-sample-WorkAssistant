...
@section('script')
    <script>
        window.getUrl = '{{ route('admin.palettes.data', ['type' => 'advanced']) }}'
        window.storeUrl = '{{ route('admin.palettes.store', ['type' => 'advanced']) }}'
        window.removeUrl = '{{ route('admin.palettes.delete', ['type' => 'advanced']) }}'
        window.updateUrl = '{{ route('admin.palettes.update', ['type' => 'advanced']) }}'
        window.sortUrl = '{{ route('admin.palettes.sort', ['type' => 'advanced']) }}'
        @auth
