...
@section('title', 'Palettes Advanced Category')

@section('breadcrumb')
    <div class="col-md-6 text-left">
        <x-layout.breadcrumb :menus="['Palettes', 'Advanced','Category']"/>
    </div>
...
@section('content')
    ...
    <div class="modal fade" id="create_modal" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@section('script')
    <script>
      let getDataTableUrl = '{{route('admin.palettes.categories.datatable', ['type' => 'advanced'])}}'
      let sortViewUrl = '{{route('admin.palettes.categories.sort.view', ['type' => 'advanced'])}}'
      let sortUrl = '{{route('admin.palettes.categories.sort', ['type' => 'advanced'])}}'
      let storeUrl = '{{route('admin.palettes.category.store', ['type' => 'advanced'])}}'
      let switchUrl = '{{route('admin.palettes.category.switch', ['type' => 'advanced'])}}'
    </script>
