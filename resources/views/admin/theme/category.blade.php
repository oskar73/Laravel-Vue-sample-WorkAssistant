...
@section('script')
    <script>
        ...
        let getThemeCategoryUrl = '{{ route('admin.theme.category.index') }}'
        let createThemeCategoryUrl = '{{ route('admin.theme.category.store') }}'
        let getThemeCategorySortUrl = '{{ route('admin.theme.category.get-sort') }}'
        let updateThemeCategorySortUrl = '{{ route('admin.theme.category.update-sort') }}'
        let switchThemeCategoryUrl = '{{ route('admin.theme.category.switch') }}'
    </script>
    <script src="{{s3_asset('vendors/jquery/jquery-ui.min.js')}}"></script>
    <script src="{{asset('assets/js/admin/theme/category.js')}}"></script>
@endsection
