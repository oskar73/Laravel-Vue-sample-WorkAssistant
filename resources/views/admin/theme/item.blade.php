...
@section('script')
    <script>
        let getThemeItemsUrl = '{{ route('admin.theme.item.index') }}';
        let switchThemeItemsUrl = '{{ route('admin.theme.item.switch') }}';
    </script>
    <script src="{{ asset('assets/js/admin/theme/item.js') }}"></script>
@endsection
