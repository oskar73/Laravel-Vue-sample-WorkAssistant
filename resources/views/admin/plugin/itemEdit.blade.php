...
@section('content')
    <div class="tabs-wrapper">
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all">Plugin Detail</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#meeting" href="#/meeting">Meeting and Attach Form</a></li>
        </ul>
    </div>
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="all_area">
        <div class="m-portlet__body">
            <form action="{{route('admin.plugin.item.update', $item->id)}}" id="submit_form" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group slimdiv mb-5" style="height: 300px; width: 300px; margin: auto">
                            <label for="thumbnail" class="form-control-label">Thumbnail</label>
    ...
    @include("components.admin.common.meetingForm", ['action'=>route('admin.plugin.item.updateMeetingForm', $item->id)])
@endsection
@section('script')
    ...
    <script src="{{asset('assets/js/admin/plugin/itemEdit.js')}}"></script>
