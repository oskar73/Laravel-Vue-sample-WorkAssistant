...
@section('title', 'LiveChat Setting')
@section('style')
@endsection
@section('breadcrumb')
...
@section('content')
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50">
        ...
        <div class="m-portlet__body">
            <form action="{{route('admin.livechat.setting.store')}}" id="submit_form">
                @csrf
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/livechat/setting.js')}}"></script>
@endsection
