...
@section('breadcrumb')
    ...
    <div class="col-md-6 text-right">
        <a href="{{route('admin.domainList.index')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-danger mb-2"> Back</a>
    </div>
@endsection
...
<div class="domain_search_area">
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="detail_area">
        ...
        <h4>Contact Details</h4> <br>
            <form action="{{route('admin.domainList.updateContact', $domain->id)}}" method="POST" id="contact-form">
                @csrf
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/domainList/show.js')}}"></script>
@endsection
