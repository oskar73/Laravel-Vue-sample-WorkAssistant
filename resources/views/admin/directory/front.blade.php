        ...
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory</span>
                </a>
            </li>
            <li class="m-nav__separator">/</li>
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Directory Setting</span>
                </a>
            </li>
        </ul>
    </div>
...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <form method="post" action="{{route('admin.directory.front.store')}}" id="submit_form" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group m-form__group" >
                                    ...
                                    <div class="slimdiv">
                                        <input type="file" data-url="{{uploadUrl(option('directory.front.header.image'))}}" name="headerImage" id="slimInput1"/>
                                    </div>
                                </div>
                                <div class="form-group m-form__group" >
                                    <label for="nav_image" class="form-control-label text-bold h4">
                                    ...
                                    <div class="slimdiv">
                                        <input type="file"  data-url="{{uploadUrl(option('directory.front.box.image'))}}"  name="boxImage" id="slimInput2"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="my-4 text-bold">Directory SEO Setting</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <textarea class="form-control m-input m-input--square minh-100px" rows="12" name="description" id="meta_description">{{$seo['description']??''}}</textarea>
                                    </div>
