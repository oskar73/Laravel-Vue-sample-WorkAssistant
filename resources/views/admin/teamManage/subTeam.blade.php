...
@section('breadcrumb')
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__separator">/</li>
            <li class="m-nav__item">
                <a href="{{route('admin.teamManage.team.index')}}" class="m-nav__link">
                    <span class="m-nav__link-text">{{$team->name}}</span>
                </a>
            </li>
            <li class="m-nav__separator">/</li>
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Sub Teams</span>
                </a>
            </li>
        </ul>
    </div>
    <div class="col-md-6 text-right">
        <a href="{{route('admin.teamManage.team.index')}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-info mb-2">Back</a>
        <a href="{{route('admin.teamManage.team.create', $team->slug)}}" class="ml-auto btn m-btn--square m-btn--sm btn-outline-success createBtn mb-2">Create</a>
    </div>
@endsection
...
@endsection
@section('script')
    <script>var slug = "{{$team->slug}}"</script>
    <script src="{{asset('assets/js/admin/teamManage/subTeam.js')}}"></script>
@endsection
