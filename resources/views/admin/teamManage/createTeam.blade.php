...
@section('breadcrumb')
    <div class="col-md-6 text-left">
        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
            ...
            <li class="m-nav__item">
                <a href="" class="m-nav__link">
                    <span class="m-nav__link-text">Create Team</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="m-portlet m-portlet--mobile tab_area area-active md-pt-50" id="detail_area">
        <div class="m-portlet__body">
            <div class="container-fluid">
                <form action="{{route('admin.teamManage.team.store', $slug)}}" id="submitForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group position-relative text-center pt-5">
                                ...
                                <img id="thumbnail" class="image_upload_output w-300px" src="{{asset('assets/img/default.jpg')}}" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group pt-3 pb-3">
                                ...
                                <textarea class="form-control m-input m-input--square minh-200" name="description" id="description"></textarea>
                                ...
                                <div class="m-checkbox-list mt-3">
                                    @foreach($properties as $property)
                                        <label class="m-checkbox m-checkbox--state-success">
                                            <input type="checkbox" name="properties[]" value="{{$property->id}}"> {{$property->name}} <i class="fa fa-info-circle tooltip_1" title="{{$property->description}}"></i>
                                            <span></span>
                                        </label>
                                    @endforeach
                                </div>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/teamManage/createTeam.js')}}"></script>
@endsection
