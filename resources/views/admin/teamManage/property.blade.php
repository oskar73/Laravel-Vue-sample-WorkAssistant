...
@section('content')
    ...
    <div class="tabs-wrapper">
        ...
        <ul class="tab-nav">
            <li class="tab-item"><a class="tab-link tab-active" data-area="#all" href="#/all"> All Properties (<span class="all_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#active" href="#/active"> Active Properties (<span class="active_count">0</span>)</a></li>
            <li class="tab-item"><a class="tab-link" data-area="#inactive" href="#/inactive"> InActive Properties (<span class="inactive_count">0</span>)</a></li>
        </ul>
    </div>
                ...
                <form id="create_modal_form" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{-- <div class="form-group">
                                    <label for="thumbnail" class="form-control-label">Property Image</label>
...
@section('script')
    ...
    <script src="{{asset('assets/js/admin/teamManage/property.js')}}"></script>
@endsection
