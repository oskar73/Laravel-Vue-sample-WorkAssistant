...
@section('content')
    <div class="m-portlet m-portlet--mobile md-pt-50">
        ...
        <div class="m-portlet__body">
            <form method="post" action="{{route('admin.blog.front.store')}}" id="submit_form" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group m-form__group" x-show="status">
                                ...
                                <div class="slimdiv">
                                    <input type="file" data-url="{{ option('blog.front.header.image') }}" name="headerImage" id="slimInput1"/>
                                </div>
                            </div>

                        </div>
                        <div class="col-lg-6">
                            <h4 class="my-4 text-bold">Blog SEO Setting</h4>
