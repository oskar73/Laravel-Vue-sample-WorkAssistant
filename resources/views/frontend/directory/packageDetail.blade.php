...
@section('title', 'Directory Listing Package - ' . $item->name)

@section('seo')
    <link rel="canonical" href="{{ config('app.url') }}/directory/packages/{{ $item->slug }}">
@endsection
                ...
                <div class="col-md-7">
                    <div class="product-detail">
                        ...
                        <div class="row margin-20px-bottom">
                            <div class="col-lg-12">
                                <a href="javascript:void(0);" class="btn theme style-1 margin-15px-right xs-margin-10px-bottom addToCartBtn toggleBtn" data-cart="0">
                                    <span><i class="fas fa-shopping-cart margin-5px-right"></i> Add to Cart</span>
                                </a>
                                <a href="{{route('cart.index')}}" class="btn theme style-1 margin-15px-right xs-margin-10px-bottom toggleBtn d-none">
