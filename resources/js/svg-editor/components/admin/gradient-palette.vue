...
export default {
  ...
  mounted() {
    this.lid = this.$uuid.v4()
    this.rid = this.$uuid.v4()
  ...
  methods: {
    ...
    gotoBack() {
      if (this.category_id) {
        ...
        window.location.href = '/account/color-palettes'
      }
    },
    submit() {
      let url
      ...
      if (this.category_id) {
        ...
        url = '/account/color-palettes/gradient'
      }
        ...
        .then(function (response) {
          ...
          if (response.data.status === 1) {
            ...
            if (cat_id) {
              ...
              redirectAfterDelay('/account/color-palettes')
            }
          } else {
