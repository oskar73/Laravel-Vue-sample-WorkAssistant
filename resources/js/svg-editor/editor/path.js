...
import { transformPoint, getMatrix, snapToAngle, rectsIntersect, transformListToTransform } from './math.js'
import { assignAttributes, getElem, getRotationAngle, getBBox, getRefElem, findDefs, snapToGrid, isNullish, getBBox as utilsGetBBox } from './utilities.js'
import { supportsPathInsertItemBefore, supportsPathReplaceItem, isWebkit } from './browser.js'
      ...
      if (editorContext_.getCurrentMode() === 'path') {
        ...
        if (!drawnPath) {
          ...
          if (clickOnPoint) {
            ...
            if (!$.contains(editorContext_.getContainer(), editorContext_.getMouseTarget(evt))) {
