...
;(function (a, b) {
  ...
  function ca(a, b, c, d) {
    ...
    } else if (!c && b != null && typeof b === 'object') for (const e in b) ca(a + '[' + e + ']', b[e], c, d)
    else d(a, b)
  }
  function b_(a, c) {
    let d
    ...
    ;(e.fn = e.prototype =
      ...
      e.extend({
        ...
        merge: function (a, c) {
          let d = a.length
          let e = 0
          if (typeof c.length === 'number') for (let f = c.length; e < f; e++) a[d++] = c[e]
        ...
        grep: function (a, b, c) {
          ...
          let e
          c = !!c
          for (let f = 0, g = a.length; f < g; f++) (e = !!b(a[f], f)), c !== e && d.push(a[f])
          return d
        },
        map: function (a, c, d) {
          let f
          ...
          let i = 0
          const j = a.length
          const k = a instanceof e || (j !== b && typeof j === 'number' && ((j > 0 && a[0] && a[j - 1]) || j === 0 || e.isArray(a)))
        ...
        if (typeof a === 'undefined') {
          if (this.length) {
            ...
            if (this[0].nodeType === 1 && !f._data(this[0], 'parsedAttrs')) {
              e = this[0].attributes
              for (let i = 0, j = e.length; i < j; i++) (g = e[i].name), g.indexOf('data-') === 0 && ((g = f.camelCase(g.substring(5))), l(this[0], g, h[g]))
      ...
      (f.event.special.submit = {
        setup: function () {
          ...
          f.event.add(this, 'click._submit keypress._submit', function (a) {
            const c = a.target
            const d = f.nodeName(c, 'input') || f.nodeName(c, 'button') ? c.form : b
            d &&
              !d._submit_attached &&
    ...
    (function () {
      ...
      var o = (m.selectors = {
        ...
        find: {
          ...
          NAME: function (a, b) {
            if (typeof b.getElementsByName !== 'undefined') {
              ...
              for (let e = 0, f = d.length; e < f; e++) d[e].getAttribute('name') === a[1] && c.push(d[e])
        ...
        filter: {
          PSEUDO: function (a, b, c, d) {
            ...
            if (e === 'not') {
              const g = b[3]
              for (let h = 0, i = g.length; h < i; h++) if (g[h] === a) return !1
              return !0
            }
            m.error(e)
          },
          ...
          ATTR: function (a, b) {
            const c = b[1]
            const d = m.attr ? m.attr(a, c) : o.attrHandle[c] ? o.attrHandle[c](a) : a[c] != null ? a[c] : a.getAttribute(c)
            const e = d + ''
            const f = b[2]
            const g = b[4]
            return d == null
      ...
      try {
        ...
        s = function (a, b) {
          ...
          else if (typeof a.length === 'number') for (let e = a.length; c < e; c++) d.push(a[c])
      ...
      c.documentElement.compareDocumentPosition
        ...
        (function () {
          ...
          const b = a.matchesSelector || a.mozMatchesSelector || a.webkitMatchesSelector || a.msMatchesSelector
          if (b) {
    ...
    f.fn.extend({
      ...
      domManip: function (a, c, d) {
        ...
        if (this[0]) {
          ...
          if (g) {
            c = c && f.nodeName(g, 'tr')
            for (let l = 0, m = this.length, n = m - 1; l < m; l++) d.call(c ? bi(this[l], g) : this[l], e.cacheable || (m > 1 && l < n) ? f.clone(h, !0, !0) : h)
          }
        ...
        for (var j = 0, k; (k = a[j]) != null; j++) {
          ...
          if (typeof k === 'string') {
            if (!_.test(k)) k = b.createTextNode(k)
              ...
              k = k.replace(Y, '<$1></$2>')
              const l = (Z.exec(k) || ['', ''])[1].toLowerCase()
              ...
              if (!f.support.tbody) {
                const p = $.test(k)
                const q = l === 'table' && !p ? o.firstChild && o.firstChild.childNodes : m[1] === '<table>' && !p ? o.childNodes : []
      ...
      cleanData: function (a) {
        ...
        for (var h = 0, i; (i = a[h]) != null; h++) {
          ...
          if (c) {
            b = d[c]
            if (b && b.events) {
              for (const j in b.events) e[j] ? f.event.remove(i, j) : f.removeEvent(i, j, b.handle)
  ...
  const bG = /#.*$/
  const bH = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm
  const bI = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i
  const bJ = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/
  const bK = /^(?:GET|HEAD)$/
  const bL = /^\/\//
  const bM = /\?/
  const bN = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi
  const bO = /^(?:select|textarea)/i
  var bP = /\s+/
  const bQ = /([?&])_=[^&]*/
  const bR = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/
  const bS = f.fn.load
  ...
  ;(bW = bR.exec(bV.toLowerCase()) || []),
    ...
    f.extend({
      ...
      param: function (a, c) {
        ...
        } else for (const g in a) ca(g, a[g], c, e)
  ...
  f.fn.extend({
    ...
    f.extend({
      speed: function (a, b, c) {
        const d =
          a && typeof a === 'object' ? f.extend({}, a) : { complete: c || (!c && b) || (f.isFunction(a) && a), duration: a, easing: (c && b) || (b && !f.isFunction(b) && b) }
  ...
  'getBoundingClientRect' in c.documentElement
    ? (f.fn.offset = function (a) {
        ...
        const e = b.ownerDocument
        const g = e.documentElement
        if (!c || !f.contains(g, b)) return c ? { top: c.top, left: c.left } : { top: 0, left: 0 }
        const h = e.body
        const i = cy(e)
        const j = g.clientTop || h.clientTop || 0
        const k = g.clientLeft || h.clientLeft || 0
        const l = i.pageYOffset || (f.support.boxModel && g.scrollTop) || h.scrollTop
        const m = i.pageXOffset || (f.support.boxModel && g.scrollLeft) || h.scrollLeft
        const n = c.top + l - j
        const o = c.left + m - k
        return { top: n, left: o }
      })
    ...
    (f.offset = {
      ...
      setOffset: function (a, b, c) {
        ...
        const j = (d === 'absolute' || d === 'fixed') && f.inArray('auto', [h, i]) > -1
        const k = {}
        let l = {}
        let m
        let n
