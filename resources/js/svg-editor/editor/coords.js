...
import { snapToGrid, assignAttributes, getBBox, getRefElem, findDefs } from './utilities.js'
import { transformPoint, transformListToTransform, matrixMultiply, transformBox } from './math.js'
...
export const remapElement = function (selected, changes, m) {
  ...
  const scalew = function (w) {
    return m.a * w
  }
  const scaleh = function (h) {
    return m.d * h
  }
