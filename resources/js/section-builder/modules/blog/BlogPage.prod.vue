          ...
          <div class="col-lg-8">
            ...
            <div class="h-720x h-sm-auto blog_search_remove_section">
              <div class="h-2-3 h-sm-auto">
                <div class="h-100 w-2-3 w-sm-100 float-left p-1 h-sm-360px">
                  <a
                    v-if="featured_posts[0]" href="{{route('blog.detail', $featured_posts[0]->slug)}}"
                    class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                  >
                    <figure
                      :data-href="featured_posts[0].image"
                      class="img-bg progressive replace mb-0 img-bg-effect-container"
                    >
                      <img :src="featured_posts[0].image" :alt="featured_posts[0].title" class="preview img-bg-effect" />
                    </figure>
                ...
                <div class="h-100 w-1-3 w-sm-100 float-left h-sm-720px">
                  <div class="h-50 w-100 p-1 position-relative blog-ads-position-1111">
                    <a
                      v-if="featured_posts[1]" href="{{route('blog.detail', $featured_posts[1]->slug)}}"
                      class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                    >
                      <figure
                        :data-href="featured_posts[1].image"
                        class="img-bg progressive replace mb-0 img-bg-effect-container"
                      >
                        <img
                          :src="featured_posts[1].image" :alt="featured_posts[1].title"
                  ...
                  <div class="h-50 w-100 p-1">
                    <a
                      v-if="featured_posts[2]" href="{{route('blog.detail', $featured_posts[2]->slug)}}"
                      class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                    >
                      <figure
                        :data-href="featured_posts[2].image"
                        class="img-bg progressive replace mb-0 img-bg-effect-container"
                      >
                        <img
                          :src="featured_posts[2].image" :alt="featured_posts[2].title"
                          class="preview img-bg-effect"
                        />
                      </figure>
                      <div class="position-absolute text-white post-title-bg z-index-2 w-100 bottom-0 p-3">
            ...
            <div class="h-1-3 h-sm-auto">
              <div class="h-100 w-1-3 w-sm-100 float-left p-1 h-sm-360px position-relative blog-ads-position-1112">
                <a
                  v-if="featured_posts[3]" href="{{route('blog.detail', $featured_posts[3]->slug)}}"
                  class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                >
                  <figure
                    :data-href="featured_posts[3].image"
                    class="img-bg progressive replace mb-0 img-bg-effect-container"
                  >
              ...
              <div class="h-100 w-1-3 w-sm-100 float-left p-1 h-sm-360px">
                <a
                  v-if="featured_posts[4]" href="{{route('blog.detail', $featured_posts[4]->slug)}}"
                  class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                >
                  <figure
                    :data-href="featured_posts[4].image"
                    class="img-bg progressive replace mb-0 img-bg-effect-container"
                  >
              ...
              <div class="h-100 w-1-3 w-sm-100 float-left p-1 h-sm-360px">
                <a
                  v-if="featured_posts[5]" href="{{route('blog.detail', $featured_posts[5]->slug)}}"
                  class="h-100 d-block position-relative h-cursor f_post_item border-solid-1px"
                >
                  <figure
                    :data-href="featured_posts[5].image"
                    class="img-bg progressive replace mb-0 img-bg-effect-container"
                  >
            ...
            <div class="col-lg-8">
              <div class="row">
                  ...
                  <div class="row mb-5">
                    <div class="col-sm-6">
                      <a v-if="recent_posts[0]" href="{{route('blog.detail', $recent_posts[0]->slug)}}">
                        <figure :data-href="recent_posts[0].image" class="progressive replace h-cursor f_post_item border-solid-1px">
                    ...
                    <div class="col-sm-6">
                      <a v-if="recent_posts[1]" href="{{route('blog.detail', $recent_posts[1]->slug)}}" class="d-block mb-3">
                        <figure :data-href="recent_posts[1].image" class="progressive replace h-cursor f_post_item width-100px float-left">
                      ...
                      <a v-if="recent_posts[2]" href="{{route('blog.detail', $recent_posts[2]->slug)}}" class="d-block mb-3">
                        <figure :data-href="recent_posts[2].image" class="progressive replace h-cursor f_post_item width-100px float-left">
                      ...
                      <a v-if="recent_posts[3]" href="{{route('blog.detail', $recent_posts[3]->slug)}}" class="d-block mb-3">
                        <figure :data-href="recent_posts[3].image" class="progressive replace h-cursor f_post_item width-100px float-left">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="mb-5">
                    <a v-for="post in popular_post" :key="post.id" href="{{route('blog.detail', $post->slug)}}" class="d-block mb-3">
                  ...
                  <div class="mb-5">
                    <a v-for="post in most_discussed_posts" :key="post.id" href="{{route('blog.detail', $post->slug)}}" class="d-block mb-3">
                      <figure :data-href="post.image" class="progressive replace h-cursor f_post_item width-100px float-left">
                        <img :src="post.image" :alt="post.title" class="preview" />
                      </figure>
                      <div class="ml-120px">
...
<style scoped lang="scss">.bg-theme {
