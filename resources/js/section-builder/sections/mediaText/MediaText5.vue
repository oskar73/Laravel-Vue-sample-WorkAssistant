<template>
  <div class="bz-section-container bz-sec--media-text-5-root" :class="{ [breakPoint]: true }">
    <bz-background :setting="background" :size="sectionSize">
      <bz-container>
        <div class="tw-grid md:tw-grid-cols-2 tw-gap-8">
          <div class="max-md:tw-h-[320px]">
...
export default {
  components: { BzButtonGroup, BzSubtitle, BzTitle, BzContainer, BzBackground },
  mixins: [sectionMixin]
}
</script>
