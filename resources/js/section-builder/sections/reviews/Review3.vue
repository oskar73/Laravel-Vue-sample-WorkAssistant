<template>
  <div class="bz-section-container bz-sec--reviews-3-root" :class="{ [breakPoint]: true }">
      ...
      <bz-container>
        ...
        <bz-items v-model="data.items" :cols="setting.column" :shadow="false" :enable-sort="edit">
          <template slot-scope="{ item, index }">
            ...
            <bz-image v-if="setting.listElements.image" v-model="item.image" :ratio="1" width="80px" rounded class="my-3" />
