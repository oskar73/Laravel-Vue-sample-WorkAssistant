!(function (a) {
  function i(r, s) {
    ...
    ;(n.$form = r),
      ...
      (n.scrollTo = function (t) {
        s.scrolling && t && t.length && a(window).scrollTop() >= t.offset().top - s.scrollThreshold && a.scrollTo(t, s.scrollSpeed, { axis: 'y', offset: s.scrollOffset })
      }),
      (n.submit = function () {
        if (!i) {
          if (((i = !0), n.$submitButton[o ? 'prop' : 'attr']('disabled', !0), n.$loading.fadeIn('slow'), window.grecaptcha)) {
            ...
            if (e.length && 'invisible' === e.data('size'))
              return 'v3' === e.data('version')
                ? void grecaptcha.execute(e.data('recaptcha-id'), { action: 'quform' }).then(function (t) {
                ...
                'function' == typeof s.successStart && s.successStart.call(n, e),
                  'function' == typeof s.success
                    ...
                    : ((t = function () {
                      ...
                      s.hideFormSpeed
                        ? n.$container.fadeOut(s.hideFormSpeed).hide(0, function () {
                            t()
                          })
                        : t())
              } else {
                    ...
                    : ((i = !1),
                      ...
                      a.each(e.elementErrors, function (t, e) {
                        ...
                        'object' == typeof e.errors &&
                          0 < e.errors.length &&
                          ((i = a("[name='" + t + "']", r)).length
                            ? ((s = a('<div class="quform-errors quform-cf"/>')),
  ...
  a.fn.Quform = function (t) {
    ...
    return (
      (a.isFunction(a.scrollTo) && a.isFunction(a.fn.scrollTo)) || (e.scrolling = !1),
      this.each(function () {
        var t = a(this)
        ...
        this.each(function () {
          ...
          e.delegate('select', 'change', function () {
            o(this).val() === n.onValue &&
              (e.html('<input type="text" name="' + t.attr('name') + '" id="' + t.attr('id') + '" value="" />'),
              ...
              r.each(m.axis.split(''), function (t, e) {
                ...
                c
                  ? ((p[n] = c[s] + (l ? 0 : o - u.offset()[s])),
                    m.margin && ((p[n] -= parseInt(d.css('margin' + i), 10) || 0), (p[n] -= parseInt(d.css('border' + i + 'Width'), 10) || 0)),
                    (p[n] += f[s] || 0),
                    m.over[s] && (p[n] += d['x' === e ? 'width' : 'height']() * m.over[s]))
                  : ((i = d[s]), (p[n] = i.slice && '%' === i.slice(-1) ? (parseFloat(i) / 100) * r : i)),
                  m.limit && /^\d+$/.test(p[n]) && (p[n] = p[n] <= 0 ? 0 : Math.min(p[n], r)),
                  !t && 1 < m.axis.length && (o === p[n] ? (p = {}) : g && (a(m.onAfterFirst), (p = {})))
              }),
                a(m.onAfter)
            }
          })
    ...
    function r(t) {
      ...
      'image' === (o.clk = e).type &&
        (void 0 !== t.offsetX
          ...
          ? ((n = i.offset()), (o.clk_x = t.pageX - n.left), (o.clk_y = t.pageY - n.top))
    ...
    ;(z.fn.attr2 = function () {
      ...
      (z.fn.ajaxSubmit = function (E, t, e, i) {
        function s(t) {
          ...
          function e() {
            ...
            a.setAttribute('target', o),
              ...
              d.skipEncodingOverride || (F && !/post/i.test(F)) || M.attr({ encoding: 'multipart/form-data', enctype: 'multipart/form-data' }),
              d.timeout &&
              ...
              if (d.extraData)
                for (var n in d.extraData)
                  d.extraData.hasOwnProperty(n) &&
                    (z.isPlainObject(d.extraData[n]) && d.extraData[n].hasOwnProperty('name') && d.extraData[n].hasOwnProperty('value')
                      ? s.push(
                          z('<input type="hidden" name="' + d.extraData[n].name + '">', c)
            ...
            if (!g.aborted && !C) {
              ...
              if ((q && q.location.href !== d.iframeSrc) || v) {
                ...
                try {
                  ...
                  if ((O('isXml=' + s), !s && window.opera && (null === q.body || !q.body.innerHTML) && --S))
                    return O('requeing onLoad callback, DOM not available'), void setTimeout(u, 250)
                  ...
                  l || d.textarea
                    ? (o = q.getElementsByTagName('textarea')[0])
                      ? ((g.responseText = o.value), (g.status = Number(o.getAttribute('status')) || g.status), (g.statusText = o.getAttribute('statusText') || g.statusText))
                      : l &&
                        ((r = q.getElementsByTagName('pre')[0]),
                        (a = q.getElementsByTagName('body')[0]),
                        r ? (g.responseText = r.textContent ? r.textContent : r.innerText) : a && (g.responseText = a.textContent ? a.textContent : a.innerText))
                    : 'xml' === c && !g.responseXML && g.responseText && (g.responseXML = k(g.responseText))
                  try {
                    j = D(g, c, d)
                  } catch (t) {
                ...
                g.aborted && (O('upload aborted'), (i = null)),
                  ...
                  'success' === i
                    ? (d.success && d.success.call(d.context, j, 'success', g), b.resolve(g.responseText, 'success', g), p && z.event.trigger('ajaxSuccess', [g, d]))
                    : i && (void 0 === e && (e = g.statusText), d.error && d.error.call(d.context, g, i, e), b.reject(g, 'error', e), p && z.event.trigger('ajaxError', [g, d, e])),
          ...
          if (
            (d.iframeTarget
              ? (r = (f = z(d.iframeTarget, c)).attr2('name'))
                ? (o = r)
                : f.attr2('name', o)
              : (f = z('<iframe name="' + o + '" src="' + d.iframeSrc + '" />', c)).css({ position: 'absolute', top: '-1000px', left: '-1000px' }),
            (m = f[0]),
            (g = {
              aborted: 0,
              responseText: null,
          ...
          ;(n = a.clk) &&
            (r = n.name) &&
            !n.disabled &&
            ((d.extraData = d.extraData || {}), (d.extraData[r] = n.value), 'image' === n.type && ((d.extraData[r + '.x'] = a.clk_x), (d.extraData[r + '.y'] = a.clk_y)))
          var x = 1,
            w = 2,
          ...
          var j,
            ...
            D = function (t, e, i) {
              ...
              return (
                n && 'parsererror' === o.documentElement.nodeName && z.error && z.error('parsererror'),
        ...
        'function' == typeof E
          ...
          ? ((E = { url: E, data: t, dataType: e }), 'function' == typeof i && (E.success = i))
          : void 0 === E && (E = {}),
          (F = E.method || E.type || this.attr2('method')),
          (o = (o = 'string' == typeof (n = E.url || this.attr2('action')) ? z.trim(n) : '') || window.location.href || '') && (o = (o.match(/^([^#]+)/) || [])[1]),
          (E = z.extend(
            !0,
            { url: o, success: z.ajaxSettings.success, type: F || z.ajaxSettings.type, iframeSrc: /^https/i.test(window.location.href || '') ? 'javascript:false' : 'about:blank' },
            E
          ))
        var r = {}
        ...
        if ((E.data && ((l = z.isFunction(E.data) ? E.data(h) : E.data), (E.extraData = l), (c = z.param(l, a))), E.beforeSubmit && !1 === E.beforeSubmit(h, this, E)))
          ...
          : (x =
              (g || y) && b
                ? (function (t) {
                      ...
                      for (
                        var s = (function (t) {
                            for (var e, i = z.param(t, E.traditional).split('&'), s = i.length, n = [], o = 0; o < s; o++)
                              (i[o] = i[o].replace(/\+/g, ' ')), (e = i[o].split('=')), n.push([decodeURIComponent(e[0]), decodeURIComponent(e[1])])
                            return n
                          })(E.extraData),
                          e = 0;
                        e < s.length;
                    ...
                    E.data = null
                    var n = z.extend(!0, {}, z.ajaxSettings, E, { contentType: !1, processData: !1, cache: !1, type: F || 'POST' })
                    E.uploadProgress &&
                      (n.xhr = function () {
      ...
      (z.fn.ajaxForm = function (t, e, i, s) {
        if (
          (('string' == typeof t || (!1 === t && 0 < arguments.length)) && ((t = { url: t, data: e, dataType: i }), 'function' == typeof s && (t.success = s)),
          ...
          return t.delegation
            ? (z(document)
              ...
              this)
            : this.ajaxFormUnbind().on('submit.form-plugin', t, o).on('click.form-plugin', t, r)
        ...
        for (z.isFunction(i) && (g = z.map(g, i)), o = 0, h = g.length; o < h; o++)
          if ((a = (l = g[o]).name) && !l.disabled)
            if (t && f.clk && 'image' === l.type)
              f.clk === l && (s.push({ name: a, value: z(l).val(), type: l.type }), s.push({ name: a + '.x', value: f.clk_x }, { name: a + '.y', value: f.clk_y }))
            else if ((c = z.fieldValue(l, !0)) && c.constructor === Array) for (e && e.push(l), r = 0, u = c.length; r < u; r++) s.push({ name: a, value: c[r] })
            else if (_.fileapi && 'file' === l.type) {
              e && e.push(l)
              var v = l.files
              if (v.length) for (r = 0; r < v.length; r++) s.push({ name: a, value: v[r], type: l.type })
        ...
        return (
          t ||
            ...
            ((a = (p = (d = z(f.clk))[0]).name) &&
              !p.disabled &&
              'image' === p.type &&
              (s.push({ name: a, value: d.val() }), s.push({ name: a + '.x', value: f.clk_x }, { name: a + '.y', value: f.clk_y }))),
          s
        )
      }),
        ...
        return (
          this.each(function () {
            ...
            if (t) {
              ...
              if (e && e.constructor === Array) for (var i = 0, s = e.length; i < s; i++) o.push({ name: t, value: e[i] })
          ...
          return this.each(function () {
            ...
            s.test(t) || 'textarea' === e
              ...
              ? /MSIE/.test(navigator.userAgent)
                ...
                : z(this).val('')
              : i && ((!0 === i && /hidden/.test(t)) || ('string' == typeof i && z(this).is(i))) && (this.value = '')
          })
        }),
          ...
          this.each(function () {
            ...
            'checkbox' === e || 'radio' === e
              ...
              : 'option' === this.tagName.toLowerCase() &&
                ((t = z(this).parent('select')), i && t[0] && 'select-one' === t[0].type && t.find('option').selected(!1), (this.selected = i))
          })
        )
      }),
    ...
    !(function (t) {
      ...
      function p(t, e, i, s) {
        ;(this.id = i),
          ...
          (this.options = e),
          (this.plugins = {}),
          (this.cache = { event: {}, target: S(), disabled: A, attr: s, onTooltip: A, lastClass: '' }),
      ...
      function f(t) {
        ...
        return i(t)
          ...
          : (i(t.metadata) && (t.metadata = { type: t.metadata }),
            'content' in t &&
              (i((e = t.content)) || e.jquery || e.done ? (e = t.content = { text: (n = s(e) ? A : e) }) : (n = e.text),
              'ajax' in e &&
                ((o = e.ajax),
                (r = o && o.once !== A),
                delete e.ajax,
              ...
              'title' in e && (S.isPlainObject(e.title) && ((e.button = e.title.button), (e.title = e.title.text)), s(e.title || A) && (e.title = A))),
            'position' in t && i(t.position) && (t.position = { my: t.position, at: t.position }),
            'show' in t && i(t.show) && (t.show = t.show.jquery ? { target: t.show } : t.show === k ? { ready: k } : { event: t.show }),
            'hide' in t && i(t.hide) && (t.hide = t.hide.jquery ? { target: t.hide } : { event: t.hide }),
      ...
      ;(U._when = function (t) {
        ...
        (U.render = function (t) {
          ...
          return (
            ...
            (s.posClass = this._createPosClass((this.position = { my: c.my, at: c.at }).my)),
            (this.tooltip = n.tooltip =
              S('<div/>', {
                ...
                .append((n.content = S('<div />', { class: T + '-content', id: this._id + '-content', 'aria-atomic': k })))),
            (this.rendered = -1),
            (this.positioning = k),
            r && (this._createTitle(), S.isFunction(r) || l.push(this._updateTitle(r, A))),
        ...
        (U.destroy = function (t) {
          ...
          return (
            this.destroyed ||
              ((t === k && 'hide' !== this.triggering) || !this.rendered ? e.call(this) : (this.tooltip.one('tooltiphidden', S.proxy(e, this)), this.triggering || this.hide())),
            this.target
          )
        }),
        (r = U.checks =
            ...
            builtin: {
              '^id$': function (t, e, i, s) {
                ...
                n !== A && 0 < n.length && !S('#' + o).length
                  ? ((this._id = o),
                    this.rendered && ((this.tooltip[0].id = this._id), (this.elements.content[0].id = this._id + '-content'), (this.elements.title[0].id = this._id + '-title')))
                  : (t[e] = s)
              },
      ...
      ;(U.set = function (n, t) {
        ...
        return (
          this.checks,
          'string' == typeof n ? ((e = n), ((n = {})[e] = t)) : (n = S.extend({}, n)),
          S.each(n, function (t, e) {
            var i, s
            o && K.test(t)
              ? delete n[t]
              : ((s = (i = c(a, t.toLowerCase()))[0][i[1]]), (i[0][i[1]] = e && e.nodeType ? S(e) : e), (r = J.test(t) || r), (n[t] = [i[0], i[1], e, s]))
          }),
          f(a),
          (this.positioning = k),
        ...
        (U._update = function (t, e) {
          ...
          return this.rendered && t
            ? (S.isFunction(t) && (t = t.call(this.elements.target, s.event, this) || ''),
              S.isFunction(t.then)
                ? ((s.waiting = k),
                  t.then(
                    function (t) {
        ...
        (U._createTitle = function () {
          ...
          t.titlebar && this._removeTitle(),
            (t.titlebar = S('<div />', { class: T + '-titlebar ' + (this.options.style.widget ? n('header') : '') })
              .append((t.title = S('<div />', { id: e, class: T + '-title', 'aria-atomic': k })))
        ...
        (U.reposition = function (t, e) {
          ...
          var i,
            ...
            q = p[0].ownerDocument,
            C = this.mouse
          if (S.isArray(l) && 2 === l.length) (u = { x: z, y: L }), (w = { left: l[0], top: l[1] })
          else if ('mouse' === l)
            (u = { x: z, y: L }),
              (!f.mouse || this.options.hide.distance) && r.origin && r.origin.pageX
                ? (t = r.origin)
              ...
              (w = { left: t.pageX - w.left + ((s && s.left) || 0), top: t.pageY - w.top + ((s && s.top) || 0) }),
            ...
            if (
              ('event' === l
                ...
                : 'event' !== l && (r.target = S(l.jquery ? l : this.elements.target)),
              (l = r.target),
              0 === (l = S(l).eq(0)).length)
            )
              return this
            l[0] === gt || l[0] === mt
              ? ((y = Q.iOS ? mt.innerWidth : l.width()),
                ...
                l[0] === mt && (w = { top: (d || l).scrollTop(), left: (d || l).scrollLeft() }))
              : I.imagemap && l.is('area')
              ? (i = I.imagemap(this, l, u, I.viewport ? m : A))
              : I.svg && l && l[0].ownerSVGElement
              ? (i = I.svg(this, l, u, I.viewport ? m : A))
              : ((y = l.outerWidth(A)), (b = l.outerHeight(A)), (w = l.offset())),
              i && ((y = i.width), (b = i.height), (s = i.offset), (w = i.position)),
              (w = this.reposition.offset(l, w, p)),
              ((3.1 < Q.iOS && Q.iOS < 4.1) || (4.3 <= Q.iOS && Q.iOS < 4.33) || (!Q.iOS && 'fixed' === x)) && ((w.left -= j.scrollLeft()), (w.top -= j.scrollTop())),
              (!i || (i && i.adjustable !== A)) && ((w.left += u.x === W ? y : u.x === $ ? y / 2 : 0), (w.top += u.y === O ? b : u.y === $ ? b / 2 : 0))
          }
          return (
            (w.left += f.x + (h.x === W ? -g : h.x === $ ? -g / 2 : 0)),
            (w.top += f.y + (h.y === O ? -v : h.y === $ ? -v / 2 : 0)),
            I.viewport
              ? ((n = w.adjusted = I.viewport(this, w, c, y, b, g, v)), s && n.left && (w.left += s.left), s && n.top && (w.top += s.top), n.my && (this.position.my = n.my))
            ...
            this._trigger('move', [w, d.elem || d], t) &&
              (delete w.adjusted,
              e === A || !T || isNaN(w.left) || isNaN(w.top) || 'mouse' === l || !S.isFunction(c.effect)
                ? a.css(w)
        ...
        (U.reposition.offset = function (t, i, e) {
          ...
          if (!e[0]) return i
          for (
            var n, o, r, a, c = S(t[0].ownerDocument), l = !!Q.ie && 'CSS1Compat' !== gt.compatMode, h = e[0];
            'static' !== (o = S.css(h, 'position')) &&
              ('fixed' === o
                ? ((r = h.getBoundingClientRect()), s(c, -1))
                : (((r = S(h).position()).left += parseFloat(S.css(h, 'borderLeftWidth')) || 0), (r.top += parseFloat(S.css(h, 'borderTopWidth')) || 0)),
      ...
      ;(G.invert = function (t, e) {
              ...
              !r ||
                ...
                t
                  ? (this.mouse && (i.origin = S.event.fix(this.mouse)),
                    ...
                    !x && 'mouse' === h.target && h.adjust.mouse && (S(gt).bind('mousemove.' + T, this._storeMouse), (x = k)),
                    d || n.css('width', n.outerWidth(A)),
                    this.reposition(e, arguments[2]),
                    d || n.css('width', ''),
                    l.solo && ('string' == typeof l.solo ? S(l.solo) : S(q, l.solo)).not(n).not(l.target).qtip('hide', S.Event('tooltipsolo')))
                  : (clearTimeout(this.timers.show),
                    delete i.origin,
                    x && !S(q + '[tracking="true"]:visible', l.solo).not(n).length && (S(gt).unbind('mousemove.' + T), (x = A)),
                    this.blur(e)),
                (a = S.proxy(function () {
                  t
                    ...
                    : n.css({ display: '', visibility: '', opacity: '', left: '', top: '' }),
        ...
        (U.disable = function (t) {
          return (
            this.destroyed ||
              ('toggle' === t ? (t = !(this.rendered ? this.tooltip.hasClass(H) : this.disabled)) : 'boolean' != typeof t && (t = k),
        ...
        (U._createButton = function () {
          ...
          t.button && t.button.remove(),
            (t.button = s.jquery
              ? s
              : S('<a />', { class: 'qtip-close ' + (this.options.style.widget ? '' : T + '-icon'), title: n, 'aria-label': n }).prepend(
                  S('<span />', { class: 'ui-icon ui-icon-close', html: '&times;' })
                )),
            t.button
        ...
        (U._assignEvents = function () {
          ...
          S.each(n.events, function (t, e) {
            ...
            -1 < ('' + n.hide.event).indexOf('unfocus') &&
              this._bind(r.closest('html'), ['mousedown', 'touchstart'], function (t) {
                var e = S(t.target),
            ...
            'number' == typeof n.hide.inactive && (this._bind(e, 'qtip-' + this.id + '-inactive', g, 'inactive'), this._bind(o.add(s), y.inactiveEvents, g)),
            this._bindEvents(h, u, e, o, d, m),
            this._bind(e.add(s), 'mousemove', function (t) {
              var e, i, s
              'number' == typeof n.hide.distance &&
                ((e = this.cache.origin || {}), (i = this.options.hide.distance), ((s = Math.abs)(t.pageX - e.pageX) >= i || s(t.pageY - e.pageY) >= i) && this.hide(t)),
                this._storeMouse(t)
            }),
            'mouse' === t.target &&
              t.adjust.mouse &&
        ...
        (U._unassignEvents = function () {
          var t = this.options,
            ...
            i = t.hide.target,
            s = S.grep(
              [this.elements.target[0], this.rendered && this.tooltip[0], t.position.container[0], t.position.viewport[0], t.position.container.closest('html')[0], mt, gt],
              function (t) {
        ...
        S(function () {
          t(q, ['mouseenter', 'mouseleave'], function (t) {
            var e = 'mouseenter' === t.type,
              ...
              n = this.options
            e
              ? (this.focus(t), i.hasClass(N) && !i.hasClass(H) && clearTimeout(this.timers.hide))
              : 'mouse' === n.position.target && n.position.adjust.mouse && n.hide.event && n.show.target && !s.closest(n.show.target[0]).length && this.hide(t),
              i.toggleClass(R, e)
          }),
            t('[' + u + ']', C, g)
        }),
            ...
            return (!arguments.length && a) || 'api' === s
              ...
              : ((a = f(S.extend(k, {}, t))),
                this.each(function (t) {
                  ...
                  return (
                    (i = !i || i === A || i.length < 1 || y.api[i] ? y.nextid++ : i),
                    (e = (function (t, e, i) {
                      var s,
                        n,
                        o,
            ...
            attr: function (t, e) {
              if (this.length) {
                ...
                if ('title' === t && s && 'object' == typeof s && s.options.suppress)
                  return arguments.length < 2 ? S.attr(i, Y) : (s && 'title' === s.options.content.attr && s.cache.attr && s.set('content.text', e), this.attr(Y, e))
              }
        ...
        (y.defaults = {
          ...
          hide: { target: A, event: 'mouseleave', effect: k, delay: 0, fixed: A, inactive: A, leave: 'window', distance: A },
      ...
      ut
        ? ((tt = mt.devicePixelRatio || 1),
          (et =
            (nt = gt.createElement('canvas').getContext('2d')).backingStorePixelRatio ||
        ...
        S.extend(e.prototype, {
          init: function (t) {
            var e,
              i = (this.element = t.elements.tip = S('<div />', { class: T + '-tip' }).prependTo(t.tooltip))
            ut
              ? (((e = S('<canvas />').appendTo(this.element)[0].getContext('2d')).lineJoin = 'miter'), (e.miterLimit = 1e5), e.save())
          ...
          _parseColours: function (t) {
            var e = this.qtip.elements,
              ...
              r = []
            return (
              (r[0] = o(i, ct) || o(n, ct) || o(e.content, ct) || o(e.tooltip, ct) || i.css(ct)),
              (r[1] = o(i, s, at) || o(n, s, at) || o(e.content, s, at) || o(e.tooltip, s, at) || e.tooltip.css(s)),
              S('*', i)
                .add(i)
                .css('cssText', ct + ':' + lt + ht + ';' + rt + ':0' + ht + ';'),
              r
            )
          },
          ...
          create: function () {
            ...
            return (
              (this.enabled = !!this.corner && 'c' !== this.corner.abbrev()) && ((this.qtip.cache.corner = t.clone()), this.update()),
          ...
          update: function (t, e) {
            ...
            ;(t = t || this.qtip.cache.corner || this.corner),
              ...
              (a =
                t.precedance === E
                  ? [g(m.x === z ? l : m.x === W ? c[0] - f[0] - l : (c[0] - f[0]) / 2), g(m.y === L ? c[1] - f[1] : 0)]
                  : [g(m.x === z ? c[0] - f[0] : 0), g(m.y === L ? l : m.y === O ? c[1] - f[1] - l : (c[1] - f[1]) / 2)]),
              ut
                ? ((n = d[0].getContext('2d')).restore(),
                  ...
                  (n.fillStyle = i[0]),
                  n.fill())
                : ((o = 'm' + (o = this._calculateTip(m))[0] + ',' + o[1] + ' l' + o[2] + ',' + o[3] + ' ' + o[4] + ',' + o[5] + ' xe'),
                  ...
                  d
                    ...
                    .each(function (t) {
                      var e = S(this)
                      e[e.prop ? 'prop' : 'attr']({ coordsize: c[0] + l + ' ' + (c[1] + l), path: o, fillcolor: i[0], filled: !!t, stroked: !t }).toggle(!(!l && !t)),
          ...
          calculate: function (o, r) {
            ...
            return (
              ...
              S.each(t, function (t, e) {
                var i, s, n
                e === $
                  ? ((u[(i = a === E ? z : L)] = '50%'), (u[ot + '-' + i] = -Math.round(r[a === E ? 0 : 1] / 2) + h))
              ...
              (u[o[a]] -= r[a === D ? 0 : 1]),
              e.css({ margin: '', top: '', bottom: '', left: '', right: '' }).css(u),
              u
            )
          },
          reposition: function (t, e, s) {
            function i(t, e, i, s, n) {
              t === P && c.precedance === e && l[s] && c[i] !== $
                ...
                : t !== P && l[s] && (c[e] = c[e] === $ ? (0 < l[s] ? s : n) : c[e] === s ? n : s)
            }
            function n(t, e, i) {
              c[t] === $
                ? (f[ot + '-' + e] = p[t] = o[ot + '-' + e] - l[e])
                : ((r = o[i] !== vt ? [l[e], -o[e]] : [-l[e], o[e]]), (p[t] = Math.max(r[0], r[1])) > r[0] && ((s[e] -= l[e]), (p[e] = A)), (f[o[i] !== vt ? i : e] = p[t]))
            }
            ...
            this.enabled &&
              ...
              (f = {}),
              this.corner.fixed !== k &&
                (i(u, D, E, z, W), i(d, E, D, L, O), (c.string() === a.corner.string() && a.cornerTop === l.top && a.cornerLeft === l.left) || this.update(c, A)),
        ...
        S.extend(k, y.defaults, { style: { tip: { corner: k, mimic: A, width: 6, height: 6, border: k, offset: 0 } } }),
        (I.viewport = function (t, b, e, i, s, n, o) {
          function r(t, e, i, s, n, o, r, a, c) {
            ...
            return (
              d
                ? ((y = (h === n ? 1 : -1) * p),
                  (b[n] += 0 < g ? g : 0 < v ? -v : 0),
                  (b[n] = Math.max(-w[n] + C[n], l - y, Math.min(Math.max(-w[n] + C[n] + (r === F ? _ : j), l + y), b[n], 'center' === h ? l - p : 1e9))))
                : ((s *= 'flipinvert' === i ? 2 : 0),
                  0 < g && (h !== n || 0 < v) ? ((b[n] -= y + s), x.invert(t, n)) : 0 < v && (h !== o || 0 < g) && ((b[n] -= (h === $ ? -y : y) + s), x.invert(t, o)),
          ...
          return f.jquery && c[0] !== mt && c[0] !== gt.body && 'none' !== h.method
            ? ((w = m.offset() || g),
              (T = 'static' === m.css('position')),
              (a = 'fixed' === l.css('position')),
              (_ = f[0] === mt ? f.width() : f.outerWidth(A)),
              (j = f[0] === mt ? f.height() : f.outerHeight(A)),
              (q = { left: a ? 0 : f.scrollLeft(), top: a ? 0 : f.scrollTop() }),
              (C = f.offset() || g),
              ('shift' === d && 'shift' === p) || (x = S.clone()),
              (g = { left: 'none' !== d ? r(D, E, d, h.x, z, W, F, i, n) : 0, top: 'none' !== p ? r(E, D, p, h.y, L, O, M, s, o) : 0, my: x }))
            : g
        })
    })
  })(window, document)
