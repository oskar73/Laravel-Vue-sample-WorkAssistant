...
$(function () {
  ...
  $.ajax({
    url: '/account/domainList/getDetail/' + domain_id,
  ...
  $.ajax({
    url: '/account/domainList/getContact/' + domain_id,
    success: function (result) {
      console.log(result)
      if (result.error) {
        dispErrors(result.message)
  ...
  $.ajax({
    url: '/account/domainList/getHosts/' + domain_id,
    success: function (result) {
      console.log(result)
      if (result.error) {
  ...
  $.ajax({
    url: '/account/domainList/getLocked/' + domain_id,
    success: function (result) {
      if (result.status == 0) {
  ...
  $.ajax({
    url: '/account/domainList/getDns/' + domain_id,
    success: function (result) {
      if (result.status == 0) {
        dispErrors(result.data)
      } else {
...
$(document).on('click', '.updateBtn', function (e) {
  ...
  $.ajax({
    url: '/account/domainList/setHosts/' + domain_id,
...
function switchLockedAndWhoisGuard() {
  $.ajax({
    url: '/account/domainList/switchAction/' + domain_id,
