...
calendar.fullCalendar({
    ...
    bootstrap: false,
    events: `/account/appointment/unavailable-dates/${type}/${id}`,
...
function editEvent(date) {
    $.ajax({
        url: `/account/appointment/unavailable-dates/edit/${type}/${id}`,
        data: { date: date },
...
function deleteAction() {
    $.ajax({
        url: `/account/appointment/unavailable-dates/delete/${type}/${id}`,
        method: 'POST',
...
$('#blockDateForm').on('submit', function (e) {
    ...
    $.ajax({
        url: `/account/appointment/unavailable-dates/${type}/${id}`,
        method: 'POST',
