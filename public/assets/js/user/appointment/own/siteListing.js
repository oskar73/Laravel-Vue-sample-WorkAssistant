...
calendar.fullCalendar({
  ...
  bootstrap: false,
  events: '/account/appointment/site-listing',
  ...
  eventClick: function (e) {
    window.location.href = `/account/appointment/site-listing/detail/${e.id}`
  },
...
function appointmentSetParam(status) {
  let ajax = {
    url: '/account/appointment/site-listing/getData',
    type: 'get',
...
function renderTable(eventObj) {
  ...
  $('.table_body').append(`
        <tr>
            ...
            <td>
                <a href="/account/appointment/site-listing/detail/${eventObj.id}"
...
$('#appointmentDateForm').on('submit', function (e) {
    ...
    $.ajax({
        url: `/account/appointment/site-listing/store`,
        method: 'POST',
