...
class PluginCategory extends BaseModel implements HasMedia
{
    use Sluggable;
    ...
    {
        return $this->belongsTo(PluginCategory::class, 'parent_id')->withDefault();
    }
    ...
    {
        return $this->hasMany(Plugin::class, 'category_id')->status(1);
    }
