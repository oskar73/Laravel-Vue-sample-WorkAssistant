...
class PortfolioCategory extends BaseModel implements HasMedia
{
    ...
    {
        return $this->hasMany(\App\Models\PortfolioCategory::class, 'parent_id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\PortfolioCategory::class, 'parent_id')->withDefault();
    }
    public function items()
    {
        return $this->hasMany(\App\Models\Portfolio::class, 'category_id')
            ->with('categories', 'media');
    }
    public function approvedItems()
    {
        return $this->hasMany(\App\Models\Portfolio::class, 'category_id')->status(1);
    }
