...
class PackageCategory extends BaseModel implements HasMedia
{
    use Sluggable;
    ...
    {
        return $this->belongsTo(PackageCategory::class, 'parent_id')->withDefault();
    }
    ...
    {
        return $this->hasMany(Package::class, 'category_id')->status(1);
    }
