...
class ServiceCategory extends BaseModel implements HasMedia
{
    ...
    {
        return $this->hasMany(\App\Models\ServiceCategory::class, 'parent_id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\ServiceCategory::class, 'parent_id')->withDefault();
    }
    ...
    {
        return $this->hasMany(\App\Models\Service::class, 'category_id')->status(1);
    }
