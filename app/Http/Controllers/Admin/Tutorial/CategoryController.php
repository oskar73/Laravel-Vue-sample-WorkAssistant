...
class CategoryController extends AdminController
{
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.tutorialCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.tutorialCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.tutorialCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.tutorialCategory', [
        ...
        return view(self::$viewDir.'tutorial.category');
    }
