...
class PageController extends AdminController
{
    ...
    public function index($template_id)
    {
        try {
            ...
            $pages = $this->model->with('parent')
                ...
                ->get();
            $data = view('components.admin.templatePage', ['pages' => $pages, 'selector' => 'page-table', 'template' => $template])->render();
    ...
    public function store(Request $request, $template_id): object
    {
        try {
            ...
            $data['route'] = route("admin.template.page.editPage", $page->id);
    ...
    public function addNewPage(Request $request): JsonResponse
    {
        try {
            ...
            $page = TemplatePage::with(['sections' => function ($query) {
    ...
    public function duplicatePage(TemplatePage $page): JsonResponse
    {
        $newPage = $page->replicatePage();
