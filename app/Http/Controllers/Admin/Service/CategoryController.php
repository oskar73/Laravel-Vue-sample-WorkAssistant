...
class CategoryController extends AdminController
{
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.serviceCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.serviceCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.serviceCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.serviceCategory', [
        ...
        return view(self::$viewDir.'service.category');
    }
