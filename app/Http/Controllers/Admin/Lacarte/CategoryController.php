...
{
    public function __construct(LacarteCategory $model)
    {
        $this->model = $model;
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.lacarteCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.lacarteCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.lacarteCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.lacarteCategory', [
        ...
        return view(self::$viewDir.'lacarte.category');
    }
