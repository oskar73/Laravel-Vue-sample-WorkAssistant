...
class CategoryController extends AdminController
{
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.readymadeCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.readymadeCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.readymadeCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.readymadeCategory', [
        ...
        return view(self::$viewDir.'readymade.category');
    }
