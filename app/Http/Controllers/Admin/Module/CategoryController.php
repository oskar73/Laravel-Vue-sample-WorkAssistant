...
{
    public function __construct(ModuleCategory $model)
    {
        $this->model = $model;
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.moduleCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.moduleCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.moduleCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.moduleCategory', [
        ...
        return view(self::$viewDir.'module.category');
    }
