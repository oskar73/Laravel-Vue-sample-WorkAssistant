...
class CategoryController extends UserController
{
    ...
    public function index()
    {
        if (request()->wantsJson()) {
            ...
            $all = view('components.admin.templateCategory', [
                'categories' => $categories,
                'selector' => "datatable-all",
            ])->render();
            $active = view('components.admin.templateCategory', [
                'categories' => $activeCats,
                'selector' => "datatable-active",
            ])->render();
            $inactive = view('components.admin.templateCategory', [
                'categories' => $inactiveCats,
                'selector' => "datatable-inactive",
            ])->render();
            $subcategory = view('components.admin.templateCategory', [
        ...
        return view('admin.templates.category', ['user' => true]);
    }
