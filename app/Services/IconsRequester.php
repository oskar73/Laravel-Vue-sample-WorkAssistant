...
class IconsRequester
{
     ...
     * @return  null|array
     */
    protected function _get(string $path, array $params = []): ?array
    {
     ...
     * @return  null|array
     */
    protected function _post(string $path, array $data = [], bool $live = true): ?array
    {
        $this->_setupConnection();
        $url = ($this->_base).($path);
        if ($live === false) {
     ...
     * @return  null|array
     */
    public function getCollectionIconsById(int $id, array $options = []): ?array
    {
     ...
     */
    public function getCollectionIconsBySlug(string $slug, array $options = []): ?Collection
    {
     ...
     * @return  null|array
     */
    public function getUserUploads(string $username, array $options = []): ?array
    {
     ...
     * @return  null|array
     */
    public function notify(string $type, array $data = [], bool $live = true): ?array
    {
        $path = '/notify/'.($type);
